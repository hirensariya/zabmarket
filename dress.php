      ...
      <div class="col-sm-2 grid-items">
        <div class="card" id="newp">
          ...
          <div class="card-text">
            ...
            <a href="buy.php?id=<?php echo ($re['id']); ?>" class="btn btn-success text-light"> Buy Now</a> &nbsp; <a href="addcartd.php?id=<?php echo ($re['id']); ?>" class="btn btn-danger text-light"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add To Cart</a> <br /><br />
                 </div>
        </div>
      </div>
    <?php
