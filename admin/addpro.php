  ...
  <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 order-md-1">
                    ...
                    <form class="needs-validation" novalidate="" action="newpro.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="pname" name="pname" placeholder="Product name" autofocus="" required="">
                            <div class="invalid-feedback">
                                Please enter Product Name
                            </div>
                        </div>
